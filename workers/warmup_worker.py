...
def execute_stage_1_task(self, account_id, data):
    ...
    with flask_app.app_context():
        ...
        try:
            ...
            async def run():
                # We need to wrap the logic in a task function that accepts client
                async def task_stage_1(client):
                    try:
                        ...
                        # Execute logic using the shared client
                        # Note: execute_warmup_action adds presence logic. Orchestrator handles connection.
                        # execute_warmup_action uses client.is_connected() check which will pass.
                        return await execute_warmup_action(client, account_id, profile_action, estimated_duration=600)
                ...
                try:
                    return await bot.execute(task_stage_1)
                finally:
                    await bot.stop()
            ...
            async def run():
                async def task_stage_2(client):
                    try:
                        ...
                        return await execute_warmup_action(client, account_id, contacts_action, estimated_duration=300)
                    except Exception as e:
                        raise e
                ...
                bot = SessionOrchestrator(account_id)
                try:
                    return await bot.execute(task_stage_2)
                finally:
                    await bot.stop()
            ...
            async def run():
                async def task_stage_3(client):
                    try:
                        ...
                        return await execute_warmup_action(client, account_id, channels_action, estimated_duration=600)
                ...
                bot = SessionOrchestrator(account_id)
                try:
                    return await bot.execute(task_stage_3)
                finally:
                    await bot.stop()

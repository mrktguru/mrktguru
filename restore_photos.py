...
async def restore_photo(account_id):
    ...
    # Need app context for DB access inside get_telethon_client and updates
        ...
        try:
            ...
            if hasattr(me, "photo") and me.photo:
                ...
                if os.path.exists(filepath):
                    # Update DB (account_id passed in args is int, assume valid)
                    # Re-fetch account instance inside this session to be safe
